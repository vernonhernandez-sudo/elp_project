...
export const DEFAULT_CLASP_OAUTH_CLIENT_ID = '1072944905499-vm2v2i5dvn0a0d2o4ca36i1vge8cvbn0.apps.googleusercontent.com';
export const DEFAULT_CLASP_OAUTH_CLIENT_SECRET = 'v6V3fKV_zWU7iw1DrpO1rknX';
export function getOAuthClientType(clientId) {
    if (!clientId) {
        return undefined;
    }
